...
export const ChannelForm = () => {
  ...
  return (
    <div className={[style.colorBg, "absolute top-0 left-0 right-0 bottom-0 flex  justify-center items-center"].join(" ")}>
        ...
        <div className={"relative w-[25vw] h-[28vw] bg-gradient-to-br from-[#457B9D] to-[#1D3557] rounded-[2vw] flex flex-col justify-evenly items-center gap-[0.8vw]"}>
          ...
          <div className={'h-[4vw] w-[20vw] flex flex-col justify-center items-center'}>
              ...
              <div className={[style2.font2, "text-[0.8vw]  text-[#A8DADC] flex justify-center items-center  h-[40%] w-[10vw]  gap-[1vw]"].join(" ")}>
                ...
                <label className={!inputRefProtected?.current?.checked && style2.checkbox || inputRefProtected?.current?.checked && style2.checkedClass } >
                  <input type="checkbox" ref={inputRefProtected} name="checkboxProtected" onClick={handleCheckboxClick}/>
